...
def display_game_over():
    ...
    rect_game_over = txt_game_over.get_rect(center=(int(screen_width/2), int(screen_height/2))) # 화면 중앙 표시
...
while running:
    ...
    # 시간 계산
    elapsed_time = (pygame.time.get_ticks() - start_ticks) / 1000 # mili second -> second
