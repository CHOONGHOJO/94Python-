...
class Claw(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        # self.rect = self.image.get_rect(center=rect_center)  # 필수 선언
    ...
    def draw(self, screen):
        ...
        pygame.draw.line(screen, BLACK, self.position,
                         self.rect.center, 5)  # 직선 그리기
...
def setup_gemstone():
    ...
    small_gold = Gemstone(gemstone_images[0], (200, 380))  # 작은 금
